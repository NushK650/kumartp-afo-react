...
import { getComputerChoice } from "../services/HWService.js";

const HW = () => {
  const defaultText = "Whats your name?";
  ...
  return (
    <>
      <div className="bg-[url('/src/assets/background.jpeg')] bg-cover min-h-screen bg-no-repeat">
        ...
        <h1
          id="centerText"
          className=" text-white md:text-[80px] text-[50px] sm:text-[60px] lg:text-[100px] text-center mt-40"
        >
          {displayText}
        </h1>
        <input
